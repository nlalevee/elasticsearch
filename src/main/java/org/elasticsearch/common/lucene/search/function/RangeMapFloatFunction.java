...
/**
 * <code>LinearFloatFunction</code> implements a linear function over another
...
public class RangeMapFloatFunction extends ValueSource {
    ...
    public boolean equals(Object o) {
        ...
        return this.min == other.min
                ...
                && (this.defaultVal == other.defaultVal || (this.defaultVal != null && this.defaultVal
                        .equals(other.defaultVal)));
    }
}
