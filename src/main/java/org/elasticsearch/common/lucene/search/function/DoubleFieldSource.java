...
/**
 * Obtains float field values from the {@link org.apache.lucene.search.FieldCache} using <code>getFloats()</code> and
...
public class DoubleFieldSource extends FieldCacheSource {
    ...
    public DocValues getValues(IndexReader reader) throws IOException {
        final double[] arr = (parser == null) ? cache.getDoubles(reader, field) : cache.getDoubles(reader, field,
                parser);
