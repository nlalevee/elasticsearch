 ...
 */
public class ESHighlighter {

    protected final SearchContext context;

    protected final List<SearchContextHighlight.Field> fields;
    ...
    public ESHighlighter(SearchContext context, List<SearchContextHighlight.Field> fields) {
